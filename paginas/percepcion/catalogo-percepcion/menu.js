...
let input_nombrePercepcion = document.getElementById('');

iframe.onload = () =>
{
    input_nombrePercepcion = iframe.contentDocument.getElementById('nombrePercepcion');
};

//________________________
// ENLACES A OTRAS PAGINAS
//________________________
let a_regresarAsignar = document.getElementById( "link_regresarAsignar" );
...
function set_eventos( )
{
    ...
    boton_add.onclick = () =>
    {
        ...
        let nombrePercepcion = input_nombrePercepcion.value;
        ...
        datos.append( "nombrePercepcionE" , nombrePercepcion );

        // PASO 3:  INDICAR LA RUTA Y NOMBRE DEL ARCHIVO PHP
        //          QUE GESTIONARA Y RECIBIRA ESTOS DATOS
        let ruta = "agregar-manejo-percepcion.php";
