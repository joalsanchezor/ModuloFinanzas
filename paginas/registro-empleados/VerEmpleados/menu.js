...
let tablaEmpleado = document.getElementById('');

iframe.onload = () =>
{
    tablaEmpleado = iframe.contentDocument.getElementById('tablaEmpleado');
    consultarEmpleados();
...
let a_agregarEmpleados = document.getElementById("link_agregarEmpleados" );
