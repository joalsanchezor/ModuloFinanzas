...
function set_tooltips( )
{
    ...
    "Asignación de prestación de ley al empleado" );

    Tooltip.actualizar( boton_agregarPrestacionLey , "bottom" , "Agregar nueva prestación de ley" , 
    "Agregar nueva prestación de ley al catálogo" );
