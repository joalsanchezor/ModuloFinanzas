...
let input_nombrePrestacionLey = document.getElementById('');

iframe.onload = () =>
{
    input_nombrePrestacionLey = iframe.contentDocument.getElementById('nombrePrestacionLey');
};

//________________________
// ENLACES A OTRAS PAGINAS
//________________________
let a_link_regresarAsignarPrestacionLey = document.getElementById( "link_regresarAsignarPrestacionLey" );
...
function set_eventos( )
{
    ...
    {
        a_link_regresarAsignarPrestacionLey.click();
    }
    ...
    boton_add.onclick = () =>
    {
        ...
        let nombrePrestacionLey = input_nombrePrestacionLey.value;

        if(nombrePrestacionLey == "")
        {
        ...
        datos.append( "nombrePrestacionLey" , nombrePrestacionLey );

        // PASO 3:  INDICAR LA RUTA Y NOMBRE DEL ARCHIVO PHP
        //          QUE GESTIONARA Y RECIBIRA ESTOS DATOS
        let ruta = "agregar-manejo-prestacionLey.php";
...
function set_tooltips( )
{
    ...
    Tooltip.actualizar( boton_add , "bottom" , "Registrar percepción" , 
    "Registrar la percepción en el catálogo" );
